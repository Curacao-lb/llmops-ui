...
export const getDatasetsWithPage = (
  ...
  return request.get<GetDatasetsWithPageResponse>(`/datasets`, {
    params: { current_page, page_size, search_word },
  })
}

export const createDataset = (req: CreateDatasetRequest) => {
  return request.post<BaseResponse<unknown>>(`/datasets`, req)
}

export const updateDataset = (dataset_id: string, req: UpdateDatasetRequest) => {
  return request.post<BaseResponse<unknown>>(`/datasets/${dataset_id}`, req)
}

export const deleteDataset = (dataset_id: string) => {
  return request.post<BaseResponse<unknown>>(`/datasets/${dataset_id}/delete`)
}

export const getDataset = (dataset_id: string) => {
  return request.get<GetDatasetResponse>(`/datasets/${dataset_id}`)
}
...
export const getDocumentsWithPage = (
  ...
  return request.get<GetDocumentsWithPageResponse>(`/datasets/${dataset_id}/documents`, {
    params: req,
  })
}

export const getDocument = (dataset_id: string, document_id: string) => {
  return request.get<GetDocumentResponse>(`/datasets/${dataset_id}/documents/${document_id}`)
}
...
export const hit = (dataset_id: string, req: HitRequest) => {
  return request.post<HitResponse>(`/datasets/${dataset_id}/hit`, req)
}

export const getDatasetQueries = (dataset_id: string) => {
  return request.get<GetDatasetQueriesResponse>(`/datasets/${dataset_id}/queries`)
}

export const createDocuments = (dataset_id: string, req: CreateDocumentsRequest) => {
  return request.post<CreateDocumentsResponse>(`/datasets/${dataset_id}/documents`, req)
}

export const getDocumentsStatus = (dataset_id: string, batch: string) => {
  return request.get<GetDocumentsStatusResponse>(
...
export const getSegmentsWithPage = (
  ...
  return request.get<GetSegmentsWithPageResponse>(
...
export const getSegment = (dataset_id: string, document_id: string, segment_id: string) => {
  return request.get<GetSegmentResponse>(
    `/datasets/${dataset_id}/documents/${document_id}/segments/${segment_id}`,
  )
}
